...
$btnCalcular.onclick = function () {
  ...
  document.querySelector(".duracion").classList.add("alert");
  document.querySelector(".duracion").classList.add("alert-info");

  document.querySelector(
    "#tiempoTotal"
  ).innerHTML = `La duracion total de todos los videos es de ${horasTotales}:${minutosFinales}:${segundosFinales} hs.`;
};

$btnLimpiar.onclick = function () {
  document.querySelector(".duracion").classList.remove("alert");
  document.querySelector(".duracion").classList.remove("alert-info");
